 ...
 */
 ...
 public interface Booking
 {
   ...
   // New methods for the extended dining time feature
   public int getExtendedTime() ; // Get extension in minutes
   public void setExtendedTime(int minutes) ; // Set extension in minutes
 }